...
$totalLeadsSQL = "select lead.lead_emp_id,lead.lead_id,lead.lead_name,lead_calls.call_date_time,lead_calls.call_result,lead_calls.call_date,lead_calls.call_time,lead_calls.call_note "
        . "from lead left join lead_calls on lead.lead_id=lead_calls.call_lead_id "
        . "where lead_calls.call_note='Registered Successfully - تم التسجيل' AND lead.lead_emp_id={$_SESSION['emp_id']}";
            ...
            <div class="col-md-12">
                    ...
                    <div class="card-header bg-primary text-light">
                        <div class="row">
                            <div class="col-4 d-flex align-items-center">
                                <strong class="card-title m-0">Registered Students</strong>
                            </div>
                ...
                <div class="card-body">
                        ...
                        <nav aria-label="Page navigation example">
                            <div class="row">
                                <?php
                                $retrieveData = "SELECT lead.lead_emp_id,lead.lead_id,lead.lead_name,lead_calls.call_date_time,lead_calls.call_result,lead_calls.call_date,lead_calls.call_time,lead_calls.call_note from lead left join lead_calls"
                                        . " ON lead.lead_id=lead_calls.call_lead_id "
                                        . "where lead_calls.call_note='Registered Successfully - تم التسجيل' AND lead.lead_emp_id={$_SESSION['emp_id']}  ORDER BY lead.lead_id DESC LIMIT {$startFrom} ,{$_SESSION['num_rows']}";
...
//                                  $res=  mysqli_query($con, $num_rows);
                                  ...
                                  if(isset($totalLeads)){
                                     ...
                                     echo "<div class='col-11 text-center text-success' >Total Leads Have Registered : " . $totalLeads . "</div>";
                                  }  else{
                                    echo  "<div class='col-11 text-center text-danger'>No Leads Registered Yet" . "</div>";
                                     }
                                ?>
